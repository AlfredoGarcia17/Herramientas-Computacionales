...
class Laser(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("laser2.png").convert()
...
class Meteor(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.yy = 2
        self.image = pygame.image.load('tie pr.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('milenario3.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
def main():
    ...
    sound = pygame.mixer.Sound('XWing fire.mp3')
    pygame.mixer.music.load('Music  Asteroid chase.mp3')
